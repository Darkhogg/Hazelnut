...
public class SaveOptions {
    public final boolean reorderLevels;
    public final boolean expandBanks;

    public SaveOptions(boolean reorderLevels, boolean expandBanks) {
        this.reorderLevels = reorderLevels;
        this.expandBanks = expandBanks;
    }
}
