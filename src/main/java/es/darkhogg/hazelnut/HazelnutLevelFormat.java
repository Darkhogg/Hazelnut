...
public class HazelnutLevelFormat extends LevelFormat {
	
	public static final int VERSION = 1;
	
	private static HazelnutLevelFormat instance;
	
	private HazelnutLevelFormat() {}
	
	public static HazelnutLevelFormat getInstance() {
		if ( instance == null ) {
			instance = new HazelnutLevelFormat();
		}
		return instance;
	}
