...
public enum SelectionType {
	COMBO(SelectionCategory.COMBO),
	ITEM(SelectionCategory.ENTITY),
	ENEMY(SelectionCategory.ENTITY),
	DOOR_ITEM(SelectionCategory.ENTITY),
	SPAWN(SelectionCategory.SPECIAL);

	private final SelectionCategory category;

	private SelectionType(SelectionCategory category) {
